<%-- 
    Document   : poplipsdiary
    Created on : 12 Feb, 2020, 7:55:42 PM
    Author     : kshit
--%>
...
.footer {
  ...
  margin-top: 1000px;
    ...
    <body>
        <form  action="poplipsdiarylogic.jsp" method="post">
        <div class="header">
  <h1>Pop Lips</h1>
</div>
...
<div class="topnav">
  ...
  <div class="column middle">
    <h2>Pop Lips(Diary)</h2>
    <div>
    <img  style="width:400px;height: 500px" src="../../poplips2.jpg" alt=""/>
