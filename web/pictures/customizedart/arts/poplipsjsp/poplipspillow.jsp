<%-- 
    Document   : poplipspillow
    Created on : 12 Feb, 2020, 7:27:57 PM
    Author     : kshit
--%>
...
.footer {
  ...
  margin-top: 1000px;
    ...
    <body>
        <form  action="poplipspillowlogic.jsp" method="post">
        <div class="header">
  <h1>Pop Lips</h1>
</div>
...
<div class="topnav">
  ...
  <a href="../poplips.jsp"><<< Back</a>
</div>
          
  <div class="column middle">
    <h2>Pop Lips (Pillow)</h2>
    <div>
    <img  style="width:400px;height: 500px" src="../../poplips3.jpg" alt=""/>
