<%-- 
    Document   : poplipsframe
    Created on : 12 Feb, 2020, 7:27:30 PM
    Author     : kshit
--%>
...
.footer {
  ...
  margin-top: 1000px;
    ...
    <body>
        <form  action="poplipsframelogic.jsp" method="post">
        <div class="header">
  <h1>Pop Lips</h1>
</div>
...
<div class="topnav">
  ...
  <div class="column middle">
    <h2>Pop lips(Frame)</h2>
    <div>
    <img  style="width:400px;height: 500px" src="../../poplips1.jpg" alt=""/>
