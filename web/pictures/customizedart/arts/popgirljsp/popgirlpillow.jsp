<%-- 
    Document   : popgirlpillow
    Created on : 12 Feb, 2020, 7:24:39 PM
    Author     : kshit
--%>
...
.footer {
  ...
  margin-top: 1000px;
    ...
    <body>
        <form  action="popgirlpillowlogic.jsp" method="post">
        <div class="header">
  <h1>POP Girl</h1>
</div>
...
<div class="topnav">
  ...
  <a href="../popgirl.jsp"><<< Back</a>
</div>
          
  <div class="column middle">
    <h2>POP Girl(Pillow)</h2>
    <div>
    <img  style="width:400px;height: 500px" src="../../popgirl3.jpg" alt=""/>
