<%-- 
    Document   : popgirlframe
    Created on : 12 Feb, 2020, 7:25:20 PM
    Author     : kshit
--%>
...
.footer {
  ...
  margin-top: 1000px;
    ...
    <body>
        <form  action="popgirlframelogic.jsp" method="post">
        <div class="header">
  <h1>POP Girl</h1>
</div>
...
<div class="topnav">
  ...
  <div class="column middle">
    <h2>POP Girl(frame)</h2>
    <div>
    <img  style="width:400px;height: 500px" src="../../popgirl1.jpg" alt=""/>
