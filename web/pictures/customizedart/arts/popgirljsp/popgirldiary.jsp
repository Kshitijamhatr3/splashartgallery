<%-- 
    Document   : popgirldiary
    Created on : 12 Feb, 2020, 7:24:10 PM
    Author     : kshit
--%>
...
.footer {
  ...
  margin-top: 1000px;
    ...
    <body>
        <form  action="popgirldiarylogic.jsp" method="post">
        <div class="header">
  <h1>Pop Girl</h1>
</div>
...
<div class="topnav">
  ...
  <div class="column middle">
    <h2>Pop Girl(Diary)</h2>
    <div>
    <img  style="width:400px;height: 500px" src="../../popgirl2.jpg" alt=""/>
