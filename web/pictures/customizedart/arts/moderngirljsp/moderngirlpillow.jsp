<%-- 
    Document   : moderngirlpillow
    Created on : 12 Feb, 2020, 7:22:04 PM
    Author     : kshit
--%>
...
.footer {
  ...
  margin-top: 1000px;
    ...
    <body>
        <form  action="moderngirlpillowlogic.jsp" method="post">
        <div class="header">
  <h1>Modern Girl</h1>
</div>
...
<div class="topnav">
  ...
  <div class="column middle">
    <h2>Modern Girl(Pillow)</h2>
    <div>
    <img  style="width:400px;height: 500px" src="../../moderngirl3.jpg" alt=""/>
