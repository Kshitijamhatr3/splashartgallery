<%-- 
    Document   : modergirldiary
    Created on : 12 Feb, 2020, 7:19:50 PM
    Author     : kshit
--%>
...
.footer {
  ...
  margin-top: 1000px;
    ...
    <body>
        <form  action="moderngirldiarylogic.jsp" method="post">
        <div class="header">
  <h1>Modern Girl</h1>
</div>
...
<div class="topnav">
  ...
  <div class="column middle">
    <h2>Modern Girl(Diary)</h2>
    <div>
    <img  style="width:400px;height: 500px" src="../../moderngirl2.jpg" alt=""/>
