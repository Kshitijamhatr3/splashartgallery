<%-- 
    Document   : suprisedgirlpillow
    Created on : 12 Feb, 2020, 7:29:18 PM
    Author     : kshit
--%>
...
.footer {
  ...
  margin-top: 1000px;
    ...
    <body>
        <form  action="suprisedgirlpillowlogic.jsp" method="post">
        <div class="header">
  <h1>Suprised Girl</h1>
</div>
...
<div class="topnav">
  ...
  <a href="../suprisedgirl.jsp"><<< Back</a>
</div>
          
  <div class="column middle">
    <h2>Suprised Girl(Pillow)</h2>
    <div>
    <img  style="width:400px;height: 500px" src="../../suprisedgirl3.jpg" alt=""/>
