<%-- 
    Document   : suprisedgirlcup
    Created on : 12 Feb, 2020, 7:29:05 PM
    Author     : kshit
--%>
...
.footer {
  ...
  margin-top: 1000px;
    ...
    <body>
        <form  action="suprisedgirlcuplogic.jsp" method="post">
        <div class="header">
  <h1>Suprised Girl</h1>
</div>
...
<div class="topnav">
  ...
  <div class="column middle">
    <h2>Suprised Girl (Cup )</h2>
    <div>
    <img  style="width:400px;height: 500px" src="../../suprisedgirl5.jpg" alt=""/>
