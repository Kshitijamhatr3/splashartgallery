<%-- 
    Document   : moderngirlframe
    Created on : 12 Feb, 2020, 7:22:32 PM
    Author     : kshit
--%>
...
.footer {
  ...
  margin-top: 1000px;
    ...
    <body>
        <form  action="moderngirlframelogic.jsp" method="post">
        <div class="header">
  <h1>Modern Girl</h1>
</div>
...
<div class="topnav">
  ...
  <div class="column middle">
    <h2>Modern Girl(Frame)</h2>
    <div>
    <img  style="width:400px;height: 500px" src="../../moderngirl1.jpg" alt=""/>
