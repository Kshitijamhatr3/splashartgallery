<%-- 
    Document   : pointalism4
    Created on : 3 Feb, 2020, 12:51:42 AM
    Author     : kshit
--%>
...
function imageZoom(imgID, resultID) {
  ...
  function getCursorPos(e) {
    ...
    <body>
         <form action="plogic4.jsp" method="post">
        <div class="header">
...
<div class="topnav">
  ...
  <div class="column middle">
    ...
    <img id="myimage" style="width:400px;height: 500px" src="../images/p7.jpg" alt=""/>
  ...
  <div class="column side">
    ...
    <h2>Price - 1600 ISD </h2><br><br><br><br>
