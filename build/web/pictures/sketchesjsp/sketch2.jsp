<%-- 
    Document   : sketch2
    Created on : 12 Jan, 2020, 2:05:34 PM
    Author     : kshit
--%>
...
function imageZoom(imgID, resultID) {
  ...
  function getCursorPos(e) {
    ...
    <body>
        <form action="tryit2.jsp" method="post">
      <div class="header">
  <h1>Sketches</h1>
</div>
...
<div class="topnav">
  ...
  <div class="column middle">
    <h2>Natalie Sketch</h2>
    <div class="img-zoom-container">
    <img id="myimage" style="width:400px;height: 500px" src="../images/s2.jpg" alt=""/>
  ...
  <div class="column side">
    ...
    <h2>Price - 1500 ISD </h2><br><br><br><br>
