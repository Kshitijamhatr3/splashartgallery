<%-- 
    Document   : sketch8
    Created on : 3 Feb, 2020, 1:16:04 AM
    Author     : kshit
--%>
...
function imageZoom(imgID, resultID) {
  ...
  function getCursorPos(e) {
    ...
    <body>
        <form action="tryit8.jsp" method="post">
        <div class="header">
  <h1>Sketches</h1>
</div>
...
<div class="topnav">
  ...
  <div class="column middle">
    ...
    <img id="myimage" style="width:400px;height: 500px" src="../images/s8.jpg" alt=""/>
  ...
  <div class="column side">
    ...
    <br><br><br>
    <h3>Category - Sketch
    <br>Artist - MarK Daniel
    <br>Frames - Availabe
    <br>Size - 20.00 X 13.00 Inch 
    <br>Year - 2019
    </h3>
    <h2>Price - 1200 ISD </h2><br><br><br><br>
