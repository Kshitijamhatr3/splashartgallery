<%-- 
    Document   : sketch7
    Created on : 3 Feb, 2020, 1:15:54 AM
    Author     : kshit
--%>
...
function imageZoom(imgID, resultID) {
  ...
  function getCursorPos(e) {
    ...
    <body>
        <form action="tryit7.jsp" method="post">
        <div class="header">
  <h1>Sketches</h1>
</div>
...
<div class="topnav">
  ...
  <div class="column middle">
    ...
    <img id="myimage" style="width:400px;height: 500px" src="../images/s7.jpg" alt=""/>
  ...
  <div class="column side">
    ...
    <h2>Price - 1100 ISD </h2><br><br><br><br>
