<%-- 
    Document   : sketch4
    Created on : 12 Jan, 2020, 2:05:57 PM
    Author     : kshit
--%>
...
function imageZoom(imgID, resultID) {
  ...
  function getCursorPos(e) {
    ...
    <body>
        <form action="tryit4.jsp" method="post">
        <div class="header">
  <h1>Sketches</h1>
</div>
...
<div class="topnav">
  ...
  <div class="column middle">
    ...
    <img id="myimage" style="width:400px;height: 500px" src="../images/s4.jpg" alt=""/>
  ...
  <div class="column side">
    ...
    <h2>Price - 830 ISD </h2><br><br><br><br>
